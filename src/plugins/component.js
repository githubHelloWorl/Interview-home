...
import host_config_job from './port_config_job';

var host = host_config;
var host_job = host_config_job;
    ...
    install(Vue, optons) {
        ...
        Vue.mixin({
            ...
            methods: {
                 ...
                 */
                async $get_job(url, body, func) {
                    url = url.replace('~/', host_job);
                    if (body) {
